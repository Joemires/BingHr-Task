...
<body id="body-pd">
    <header class="header position-relative d-block bg-transparent border-bottom">
    ...
    <div class="l-navbar d-none d-md-flex p-0" id="nav-bar">
        ...
        <nav class="bg-white" style="flex-grow: 1; width: 40%">
            <a href="#" class="nav_link"> <i class='bx bxs-dashboard nav_icon'></i> <span class="nav_name">Dashboard</span> </a>
            <a href="#" class="nav_link {{ Nav::isRoute('backend.users.index') }}"> <i class='bx bx-group nav_icon'></i> <span class="nav_name">Users</span> </a>
            <a href="#" class="nav_link"> <i class='bx bx-collection nav_icon'></i> <span class="nav_name">Departments</span> </a>
            <a href="#" class="nav_link"> <i class='bx bxs-user-account nav_icon'></i> <span class="nav_name">Employee</span> </a>
            <a href="#" class="nav_link"> <i class='bx bx-chip nav_icon'></i> <span class="nav_name">Activities</span> </a>
            <a href="#" class="nav_link"> <i class='bx bx-chip nav_icon'></i> <span class="nav_name">Holidays</span> </a>
            <a href="#" class="nav_link"> <i class='bx bx-chip nav_icon'></i> <span class="nav_name">Events</span> </a>
            <a href="#" class="nav_link"> <i class='bx bx-chip nav_icon'></i> <span class="nav_name">Payroll</span> </a>

            <a href="#" class="nav_link"> <i class='bx bx-chip nav_icon'></i> <span class="nav_name">Accounts</span> </a>
            <a href="#" class="nav_link"> <i class='bx bx-chip nav_icon'></i> <span class="nav_name">Report</span> </a>
        </nav>
        {{-- <nav class="bg-dark">
            Hello
        </nav> --}}
